      ...
      <div class="row">
        ...
        <?php foreach ($prod as $produits): ?>
          ...
          <tr>
            ...
            <td><a name="" id=""  class="btn btn-danger" href="<?= WEB_ROUTE . '?controlleurs=responsable&views=delete&id_produit=' . $produits['id_produit'] ?>" role="button"><i class="fas fa-trash-alt"></i></a>
