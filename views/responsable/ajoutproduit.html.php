...
Ajouter un Produit            </div>
        ...
        <div class="user">
                ...
                <input type="hidden" name="action" value="ajoutproduit"/>
                    ...
                    <div class="row">
                        <div class="col">
                        <label for="libelle" class="form-label mt-4"><i class="fas fa-puzzle-piece"></i>Libelle</label>
                        <input type="text" name="libelle" class="form-control" placeholder="">
                        </div>
                        <div class="col">
                        <label for="quantite" class="form-label mt-4"><i class="fas fa-sort-amount-up-alt"></i>Qantite</label>
                    ...
                    <div class="row">
                        <div class="col">
                        <label for="prix" class="form-label mt-4"><i class="fas fa-tag"></i>Prix</label>
