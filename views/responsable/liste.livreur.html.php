  ...
  <li class="nav-item dropdown">
    ...
    <img class="navbar-brand " src="img/capture.png" width="" alt="">
      ...
      <div class="row">
        ...
        <tbody>
        <?php foreach ($livreur as $livreurs): ?>

          <tr>
            <td><?= $livreurs['prenom']?></td>
            <td><?= $livreurs['nom']?></td>
            <td><?= $livreurs['telephone']?></td>
            <td><a name="" id=""  class="btn bt btn-danger" href="<?= WEB_ROUTE . '?controlleurs=responsable&views=delete&id_livreur='.$livreurs['id_livreur'] ?>" role="button">SUPPRIMER&nbsp;<i class="fas fa-trash-alt"></i></a>
