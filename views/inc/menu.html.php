  ...
  <nav class="navbar navbar-expand-lg navbar-dark ">
    ...
    <?php if (est_responsable_stock()): ?>
        ...
        <ul class="nav flex-column">
            ...
            <li class="menu nav-item">
                <a class="nav-link " href="<?= WEB_ROUTE.'?controlleurs=responsable&views=ajoutproduit' ?>">ajout produit <i class="plusss fas fa-truck-loading"></i> </a>
            </li>         
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="<?= WEB_ROUTE . '?controlleurs=security&views=connexion' ?>">Facture<i class="fas fa-file-invoice"></i></a>
                </div>
            </li>
        </ul>
    </header>
...
<!-- <?php require(ROUTE_DIR.'views/inc/menu.html.php') ?> <br><br>
      <div class="container">
